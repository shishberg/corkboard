...
- **Python (device, assumed — not committed)** — planned runtime for the device-side server. [TO BE DETERMINED — not started]
...
- **HTTP client (web UI ↔ device)** — not built yet. [TO BE DETERMINED]
